    ...
    <div id="swimbi">
        <ul>
            ...
            <li><a data-icon="f193" href="#">Mitarbeiter</a>
                <ul>
                    <li><a class="menuItem" data-icon="f0c9" href="#" id="menuMitarbeiterAnzeige">Anzeigen</a></li>
            ...
            <li><a data-icon="f1b9" href="#">Fuhrpark</a>
                <ul>
                    <li><a href="#">Hersteller</a>
                        <ul>
                            <li><a class="menuItem" data-icon="f0C9" href="#" id="menuHerstellerAnzeigen">Anzeigen</a></li>
                            <li><a class="menuItem" data-icon="f0a6" href="#" id="menuHerstellerNeuAnlegen">neu Anlegen</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Autos</a>
                        <ul>
                            <li><a class="menuItem" data-icon="f0C9" href="#" id="menuAutosAnzeigen">Anzeigen</a></li>
                            <li><a class="menuItem" data-icon="f0a6" href="#" id="menuAutoNeuAnlegen">neu Anlegen</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Ausleihen</a>
                        <ul>
                            <li><a class="menuItem" data-icon="f0C9" href="#" id="menuAusleihe">Anzeigen</a></li>
                            <li><a class="menuItem" data-icon="f0a6" href="#" id="menuAusleiheNeuAnlegen">neu Anlegen</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li><a data-icon="f03A" href="#">Projekte</a>
                <ul>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuProjekteAnzeigen">Anzeigen</a></li>
                    <li><a class="menuItem" data-icon="f0a6" href="#" id="menuProjektNeuAnlegen">neu Anlegen</a></li>
                </ul>
            </li>
            <li><a data-icon="f03c" href="#">Projekt Mitarbeiter</a>
                <ul>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuProjektMitarbeiterAnzeigen">Anzeigen</a></li>
                    <li><a class="menuItem" data-icon="f0a6" href="#" id="menuProjektMitarbeiterNeuAnlegen">neu Anlegen</a></li>
                </ul>
            </li>
            <li><a data-icon="f1fe" href="#">Views</a>
                <ul>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuMitarbeiterAbteilungVorgesetzter">Mitarbeiter mit Abteilung und Vorgesetzten</a></li>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuAusleiherAutoListe">Die Ausleihenliste der Autos mit Zeiten</a></li>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuAbteilungAusleihenListe">Die Ausleihenliste der Projekte mit Zeiten</a></li>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuMitarbeiterZeitenProjekt">Zeit der Mitarbeiter im Projekt</a></li>
                    <li><a class="menuItem" data-icon="f0C9" href="#" id="menuProjektKosten">Kosten der Projekte Anzeigen</a></li>
                </ul>
            </li>
        ...
        <ul>
            ...
            <li class='has-sub'><a href='#' id="menuViews"><span>Views </span></a>
                <ul>
                    ...
                    <li>
                        <a class="menuItem" href='#' id="menuMitarbeiterZeitenProjekt"><span>Zeit der Mitarbeiter im Projekt</span></a>
                    </li>
                    <li class='last'>
