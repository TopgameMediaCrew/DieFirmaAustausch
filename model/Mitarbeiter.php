...
//        echo '</pre';
        ...
        $stmt = $pdo->prepare($sql);
        $stmt->execute([':vorname' => $id->getVorname(), ':nachname' => $id->getNachname(), ':geschlecht' => $id->getGeschlecht(), ':geburtsdatum' => $id->getGeburtsdatum(), ':abteilung_id' => $id->getAbteilung()->getId(), ':stundenlohn' => $id->getStundenlohn(), 
            ':vorgesetzter_id' => $id->getVorgesetzter()->getId()]);
    }
